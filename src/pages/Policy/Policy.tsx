...
export const Policy: FC<PolicyProps> = () => {
  ...
  return (
    <div className="w-full h-full container mx-auto">
        ...
        <div className="w-full h-[1200px] lg:h-[400px] flex flex-col items-start p-7 lg:p-20">
          <Typography
        ...
        <div className="w-full h-[600px] lg:h-[400px] flex flex-col items-start p-7 lg:p-20">
          <Typography
              className="text-[16px] font-semibold lg:text-[28px] text-[#3A3A3A] w-[361px] lg:w-[945px] leading-[38px] mb-5"
          >
            Your rights
