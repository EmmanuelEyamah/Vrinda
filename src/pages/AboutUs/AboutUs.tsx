    ...
    <div className="w-full h-full container mx-auto">
      <div className="hidden lg:block">
        ...
        <div className="flex flex-col items-center justify-start w-full h-full gap-8 pt-20 lg:pt-56 relative container">
          <Typography
              className="text-[38px] font-bold lg:text-[51px] text-[#3A3A3A] w-[361px] lg:w-[1165px] leading-[47px] lg:leading-[61px] text-center"
          >
          ...
          <Typography
              className="text-sm font-normal lg:text-[16px] text-[#3A3A3A] w-[361px] lg:w-[638px] leading-[24px] text-center"
          >
          ...
          <div className="w-full lg:hidden">
              ...
              <div className="w-1/2 p-5 flex flex-col gap-[40px]">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <Typography
                            className="font-normal lg:text-[16px]  text-[#3A3A3A] leading-[24px] w-[361px] lg:w-[548px]"
                        >
                  ...
                  <div className="flex flex-col gap-2 mt-9">
                      ...
                      <Typography
                          className="text-sm font-normal text-[16px]  lg:text-[28px]  text-[#3A3A3A] leading-[24px] lg:leading-[36px] w-[361px] lg:w-[720px]"
                      >
        ...
        <div className="h-[1500px] lg:h-[1000px] w-full flex-col-reverse flex lg:flex lg:flex-row items-start justify-center p-7 lg:p-12 gap-12 relative">
          ...
          <div className="W-1/2 flex flex-col">
            <Typography
                className="text-[21px] font-bold lg:text-[38px] text-[#3A3A3A] w-[361px] lg:w-[611px] leading-[34px] lg:leading-[47px]"
            >
            The story and mission behind our company
            </Typography>
            <Typography
                className="font-normal text-[16px] text-[#3A3A3A] w-[361px] lg:w-[605px] leading-[24px]"
            >
        ...
        <div className="h-[1400px] lg:h-[800px] w-[750px] lg:w-full flex-col flex lg:flex lg:flex-row items-start justify-center p-7 lg:p-12 gap-12 relative">
          <div className="W-1/2 flex flex-col">
              <Typography
                  className="text-[21px] font-bold lg:text-[38px] text-[#3A3A3A] w-[361px] lg:w-[596px] leading-[34px] lg:leading-[47px] mb-3"
              >
