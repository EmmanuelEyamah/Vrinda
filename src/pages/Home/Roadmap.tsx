...
export const Roadmap: FC<RoadmapProps> = () => {
  ...
  return (
    <div className="w-full h-[2200px] lg:h-[1000px] flex flex-col items-center justify-center relative gap-5 container mx-auto" id="roadmap">
         <Typography
            className="text-[21px] font-bold lg:text-[28px] text-[#3754FF] leading-[27px] lg:leading-[36px] lg:w-[250px] text-center"
        >
            LAUNCH PLAN
        </Typography>
         <Typography
            className="text-[16px] font-normal lg:text-[51px] text-[#3A3A3A] leading-[24px] lg:leading-[61px] w-[201px] lg:w-[645px]"
        >
            Our Strategy & Project Plan
        </Typography>
         <Typography
            className="text-[16px] font-normal lg:text-[16px] text-[#3A3A3A] leading-[24px] w-[306px] lg:w-[738px] text-center"
        >
        ...
        <div className="w-[1460px] flex items-center justify-center mt-[75px] relative">
            ...
            <div className="absolute top-[-80px] right-0 hidden lg:block">
                <Globe />
            </div>

            <div className="flex flex-col gap-8 lg:hidden">
                <div className="w-[300px] p-3 flex flex-col items-center gap-3 ">
